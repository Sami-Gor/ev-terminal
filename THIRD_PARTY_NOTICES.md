...
This project is distributed under the [MIT License](LICENSE) and depends on the following 106 open-source packages (including transitive dependencies), all under permissive licenses (MIT / Apache-2.0 / BSD / ISC):

| Package | Version | License |
|---|---|---|
| [accepts](jshttp/accepts) | 1.3.8 | MIT |
| [agent-base](git://github.com/TooTallNate/node-agent-base.git) | 6.0.2 | MIT |
| [ansi-regex](chalk/ansi-regex) | 6.3.0 | MIT |
| [ansi-styles](chalk/ansi-styles) | 6.2.3 | MIT |
...
| [chromium-bidi](https://github.com/GoogleChromeLabs/chromium-bidi.git) | 17.0.2 | Apache-2.0 |
| [cliui](yargs/cliui) | 9.0.1 | ISC |
...
| [devtools-protocol](https://github.com/ChromeDevTools/devtools-protocol) | 0.0.1666840 | BSD-3-Clause |
...
| [get-east-asian-width](sindresorhus/get-east-asian-width) | 1.6.0 | MIT |
...
| [modern-tar](https://github.com/ayuhito/modern-tar) | 0.8.4 | MIT |
...
| [string-width](sindresorhus/string-width) | 7.2.0 | MIT |
| [strip-ansi](chalk/strip-ansi) | 7.2.0 | MIT |
| [toidentifier](component/toidentifier) | 1.0.1 | MIT |
| [type-is](jshttp/type-is) | 1.6.18 | MIT |
| [typed-query-selector](g-plane/typed-query-selector) | 2.12.2 | MIT |
...
| [webdriver-bidi-protocol](git+https://github.com/GoogleChromeLabs/webdriver-bidi-protocol.git) | 0.4.3 | Apache-2.0 |
| [wrap-ansi](chalk/wrap-ansi) | 9.0.2 | MIT |
| [ws](https://github.com/websockets/ws) | 8.21.3 | MIT |
| [y18n](https://github.com/yargs/y18n) | 5.0.8 | ISC |
| [yargs](https://yargs.js.org/) | 18.1.0 | MIT |
| [yargs-parser](https://github.com/yargs/yargs-parser.git) | 22.0.0 | ISC |
